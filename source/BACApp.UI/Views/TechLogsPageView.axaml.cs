...
public partial class TechLogsPageView : UserControl
{
    public TechLogsPageView()
    {
        InitializeComponent();
    ...
    private void OnSelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        var viewModel = this.DataContext as TechLogsPageViewModel;
        if (viewModel != null && dataGrid != null)
        {
            viewModel.SelectedTechLogs = new System.Collections.ObjectModel.ObservableCollection<TechLog>(dataGrid.SelectedItems.Cast<TechLog>());
        }
    }
    ...
    private async Task<string?> PickExportFilePathAsync()
    {
        ...
        var aircraftReg = (DataContext as TechLogsPageViewModel)?.SelectedAircraft?.Registration ?? "unknown";
